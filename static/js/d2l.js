...
const addCopyButtonToCodeCells = () => {
  ...
  const codeCells = document.querySelectorAll('div.highlight-default:not(.m2convert) pre, div.highlight-bash pre, div.highlight-sh pre, div.highlight-python pre')
